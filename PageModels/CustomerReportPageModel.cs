...
public partial class CustomerReportPageModel : ObservableObject
{
    ...
    public CustomerReportPageModel(JobRepository jobRepository, PartnerRepository partnerRepository, JobTypeRepository jobTypeRepository,
    ...
    private async Task GenerateReport()
    {
        ...
        foreach (var group in groupedByCompany)
        {
            ...
            {
                Name = string.IsNullOrEmpty(group.Key) ? "No Name" : group.Key,
